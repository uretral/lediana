...
class ItemCoverMaterialController extends Controller
{
    ...
    {
        $grid = new Grid(new ItemCoverMaterial);
    ...
    {
        $show = new Show(ItemCoverMaterial::findOrFail($id));
    ...
    {
        $form = new Form(new ItemCoverMaterial);

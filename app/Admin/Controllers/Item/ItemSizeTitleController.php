...
class ItemSizeTitleController extends Controller
{
    ...
    {
        $grid = new Grid(new ItemSizeTitle);
    ...
    {
        $show = new Show(ItemSizeTitle::findOrFail($id));
    ...
    {
        $form = new Form(new ItemSizeTitle);

...
class ItemSpreadTypeController extends Controller
{
    ...
    {
        $grid = new Grid(new ItemSpreadType);
    ...
    {
        $show = new Show(ItemSpreadType::findOrFail($id));
    ...
    {
        $form = new Form(new ItemSpreadType);

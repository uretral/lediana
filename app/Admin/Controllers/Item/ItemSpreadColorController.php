...
class ItemSpreadColorController extends Controller
{
    ...
    {
        $grid = new Grid(new ItemSpreadColor);
    ...
    {
        $show = new Show(ItemSpreadColor::findOrFail($id));
    ...
    {
        $form = new Form(new ItemSpreadColor);

...
(function (window, document) {
	...
	Croppic = function (id, options, preset = null) {
	...
	Croppic.prototype = {
		...
		createImgUploadControls: function(){
			...
			var cropControlRemoveCroppedImage = '<button class="cropControlRemoveCroppedImage btn-base btn-action">x</button>';
			...
			var html =    '<div  class="cropControls cropControlsUpload '+ratios+'"> ' + cropControlUpload + cropControlRemoveCroppedImage + ' </div>';
...
/*			if(that.options.doubleZoomControls){
				cropControlZoomMuchIn = '<button class="cropControlZoomMuchIn btn-base btn-action">m-</button></i>';
		...
		initDrag:function(){
			...
			that.img.on("mousedown touchstart", function(e) {
				...
				that.img.css('z-index', 10).on("mousemove touchmove", function(e) {
